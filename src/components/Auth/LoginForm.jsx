    ...
    return (
        ...
        <div className="w-full max-w-md flex flex-col items-center justify-center">
          ...
          <div className="flex w-full flex-row gap-4 mb-6">
            <button className="bg-white  shadow-md flex-1 flex items-center justify-center gap-2 px-4 py-2 border-none rounded-xl text-gray-700 hover:bg-gray-100 transition">
              ...
              <span className="text-sm font-medium sm:hidden">Google</span>
             <span className="text-sm font-medium hidden sm:inline">Sign in with Google</span>

            </button>

            <button className="bg-white  shadow-sm flex-1 flex items-center justify-center gap-2 px-4 py-2 border-none  rounded-xl text-gray-700 hover:bg-gray-100 transition">
              <svg className="w-4 h-4" viewBox="0 0 24 24">
              ...
              <span className="text-sm font-medium sm:hidden">Apple</span>
              <span className="text-sm font-medium hidden sm:inline">Sign in with Apple</span>
